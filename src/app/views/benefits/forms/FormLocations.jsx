...
const FormAdminBenefits = (props) => {
    ...
    useEffect(() => { //load data when is edit form
        if (props.id && location != [] && location[0] != [""] && location[0] != undefined) {
            setLocationsForm({
    ...
    const handleFormSubmitLocation = async () => {
        ...
        if (locationsform.principalLocation) {
            ...
            mainlocation.length != 0 && await dispatch(UpdateBenefitLocation(mainlocation[0].idLocation, {
                ...mainlocation[0], provinceCode: mainlocation[0].codProvincia ? mainlocation[0].codProvincia : "", whatsapp: mainlocation[0].whatsApp,
                ...
                idBenefit: props.idBenefit, canton: mainlocation[0].canton ? mainlocation[0].canton : "", principalLocation: false
            }, { latitude: mainlocation[0].latitude ? mainlocation[0].latitude : "", longitude: mainlocation[0].longitude ? mainlocation[0].longitude : "" }));
        }
