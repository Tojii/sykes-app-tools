...
const DetalleBenefits = (props) => {
    ...
    useEffect(() => {
        ...
        setPromociones(discounts.filter(function (item) {
            ...
            if (start.getTime() > d.getTime() || end.getTime() < d.getTime() || item.benefit.idBenefit != id) { //use only active discounts
                                                                        ...
                                                                        <Grid item xs={12} sm container>
                                                                            <Grid item xs container direction="column" spacing={2}>
                                                                                <Grid item xs>
                                                                                    ...
                                                                                    {promociones.map(function (item, index) {
                                                                                        return <Typography style={{ color: "#939598", marginLeft: "3%", textAlign: "justify", display: "block" }} variant="body2" gutterBottom>
                                                                                            {promociones[index]}
                                                                                        </Typography>
                                                                                    })}
