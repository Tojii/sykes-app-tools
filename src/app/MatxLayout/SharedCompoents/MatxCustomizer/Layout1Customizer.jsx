...
const sidebarBG = [
  `${process.env.REACT_APP_PUBLIC_URL}/assets/images/sidebar/sidebar-bg-dark.jpg`,
  `${process.env.REACT_APP_PUBLIC_URL}/assets/images/sidebar/sidebar-bg-light.jpg`
];
