...
class MatxCustomizer extends Component {
  state = {
    open: false
  };
                ...
                <div className="mt-8 mb-32 mx-12">
                  ...
                  <div className="layout-boxes">
                    {this.demoLayouts.map(layout => (
                      ...
                      >
                        <Paper
                          onClick={() => this.updateSettings(layout.options)}
                          elevation={4}
                        >
                    ...
                    >
                      <Paper
                        onClick={() =>
                          this.updateSettings({ activeLayout: "layout1" })
                        }
                        elevation={4}
                      >
                        <img
                    ...
                    >
                      <Paper
                        onClick={() =>
                          this.updateSettings({ activeLayout: "layout2" })
                        }
                        elevation={4}
                      >
                        <img
